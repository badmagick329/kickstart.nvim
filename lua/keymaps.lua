...
vim.keymap.set('n', '<leader>ld', '<cmd>lua vim.diagnostic.open_float(0, {scope="line"})<cr>', { desc = 'Open line [d]iagnostics in float' })

-- better indenting
vim.keymap.set('v', '<', '<gv')
vim.keymap.set('v', '>', '>gv')

-- better scrolling: try to keep cursor centered
...
vim.keymap.set('n', '<C-j>', ':<C-U>TmuxNavigateDown<CR>', { silent = false })
vim.keymap.set('n', '<C-k>', ':<C-U>TmuxNavigateUp<CR>', { silent = false })
vim.keymap.set('n', '<C-l>', ':<C-U>TmuxNavigateRight<CR>', { silent = false })
